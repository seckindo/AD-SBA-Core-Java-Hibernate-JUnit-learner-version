...
public class StudentService implements StudentI {
	...
	public List<Course> getStudentCourses(String email) {
		...
		try {
			tx = s.beginTransaction();
			String nativeGetStudentCourses = "select c.id, c.name, c.instructor from course as c join student_courses as sc on "
					+ "c.id = sc.course_id join student as s on s.email = sc.student_email where s.email = :email";       
